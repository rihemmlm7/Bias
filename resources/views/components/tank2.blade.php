...
<body class="bg-gray-100">
  ...
  'water_color' => '#E6AC10, #FFECB9',
      ...
      <!-- Fin cuve card -->
      <div class="grid grid-cols-1 lg:grid-cols-10   gap-3  m-2 ">
      <div class="col-start-1	 col-end-6	 ">
        <div class="bg-white shadow p-4 rounded-xl mb-4">@include('components.chart')</div>


        <!-- Table -->
        <div class=" bg-customDarkBlue shadow p-2  mb-4 rounded-xl overflow-y-scroll ScrollBoot" style="height :30%">
